...
class Preprocessor():
    ...
    def __init__(self, inpath):
        ...
        self.nrows, self.ncolumns = 150, 150
    ...
    def filter(self):
        ...
        self.image = self._resize(self.image)
    ...
    def _resize(self, img):
        ...
        """   
        try:
            converted = cv.resize(img, (self.nrows, self.ncolumns), interpolation=self.interpolation)
        except:
            raise ImageProcessingError("Error in Preprocessor._resize method")
        else:
            return converted
